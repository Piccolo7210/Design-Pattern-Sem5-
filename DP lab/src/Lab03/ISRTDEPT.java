...
public class ISRTDEPT extends Department {
    public ISRTDEPT(){
        this.dept_name="ISRT";
//        this.printer_id=id;
    }
    ...
    public void getPrinter_instance() {
        if(this.printer_instance==null){
            ...
            this.printer_instance=ISRT_printer.getInstance(rand_int1);
        }
    }
    ...
    public void print_CourseRoutine() {
        getPrinter_instance();
        System.out.println("Printing Course Routine on "+this.printer_instance.printer_dept+this.printer_instance.printer_id);
    }
}
